...
(function() {
  ...
  var XmlBuilder = function(params) {
    ...
    this.header = function(version, encoding) {
      doc.push(new XmlBuilder.Header(version, encoding));
      return this;
    };
  ...
  XmlBuilder.Header = function(version, encoding) {
    var that = this;
    this.version = version;
    this.encoding = encoding;

    this.toString = function() {
      return "<?xml" + (version ? " version='" + that.version + "'" : "") +
        (encoding ? " encoding='" + that.encoding + "'" : "") + "?>\n";
    };
  };
